...
print(f'de feestlunch kost je bij de baker {totaal_prijs} euro voor de {aantal_croissantjes} croissantjes als de {aantal_kortingsbonnen} kortingsbonnen nog geldig zijn!') 
